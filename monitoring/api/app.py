"""Canonical, versioned, read-only monitoring API for the V10.1 bot."""
...
app = FastAPI(title="Binance Bot Read-only Monitor", version="3.0", **_docs)
API = "/api/v1"
...
@app.get(API + "/sharia")
def sharia(request_id: str = Depends(require_bearer)):
