...
V8.1 pinned the four protected signal methods with SHA-256 over
...
That defect is documented in BINANCE_BOT_FINAL_VERDICT_IMP.md and in
docs/audit/BLOCKER_REPORT.md.
