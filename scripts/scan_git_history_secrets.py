...
SENSITIVE_NAMES = {
    ...
    "COMMAND_HMAC_KEY", "SHARIA_HMAC_KEY", "SHARIA_RESULT_HMAC_KEY",
    "FREQTRADE_API_PASSWORD", "FREQTRADE_API_JWT_SECRET",
    "FREQTRADE_API_WS_TOKEN", "ORACLE_SSH_PRIVATE_KEY", "OPENAI_API_KEY",
    "GITHUB_TOKEN", "COINGECKO_API_KEY", "COINMARKETCAP_API_KEY",
}
