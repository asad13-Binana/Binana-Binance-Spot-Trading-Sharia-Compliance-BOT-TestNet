...
def main():
    ...
    try:
        ...
        release_mode = ''
    if release_mode not in {'testnet', 'live'}:
    ...
    if preservation.get('legacy_core_sha256') != preservation.get('expected_legacy_core_sha256'):
        errors.append('legacy core preservation hash mismatch in manifest')
