...
4. **execution-sidecar** — the **sole Binance order owner**. It verifies signed signals and requires a
...
5. **telegram-broker** — the owner-only remote control. Signs every command, Sharia scan request and
